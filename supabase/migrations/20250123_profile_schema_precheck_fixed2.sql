...
BEGIN
    ...
    FROM public.profiles WHERE "full_name" IS NULL;  -- Fixed column name with quotes
    ...
    FROM public.profiles WHERE "full_name" IS NOT NULL AND char_length("full_name") < 1;  -- Fixed column name with quotes
